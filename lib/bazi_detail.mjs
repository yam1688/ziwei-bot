...
const SHEN_SHA = {
  ...
  '天厨': { '甲':'巳','乙':'午','丙':'巳','丁':'午','戊':'申','己':'酉',
    '庚':'亥','辛':'子','壬':'寅','癸':'卯' },
  '文昌': { '甲':'巳','乙':'午','丙':'申','丁':'酉','戊':'申','己':'酉',
    '庚':'亥','辛':'子','壬':'寅','癸':'卯' },
  '禄神': { '甲':'寅','乙':'卯','丙':'巳','丁':'午','戊':'巳','己':'午',
    '庚':'申','辛':'酉','壬':'亥','癸':'子' },
  '驿马': { '寅':'申','卯':'巳','辰':'寅','巳':'亥','午':'申','未':'巳',
    '申':'寅','酉':'亥','戌':'申','亥':'巳','子':'寅','丑':'亥' },
  '将星': { '寅':'午','卯':'子','辰':'午','巳':'酉','午':'酉','未':'子',
    '申':'卯','酉':'午','戌':'卯','亥':'子','子':'酉','丑':'午' },
  '亡神': { '寅':'巳','卯':'申','辰':'亥','巳':'寅','午':'巳','未':'申',
    '申':'亥','酉':'寅','戌':'巳','亥':'申','子':'亥','丑':'寅' },
};
