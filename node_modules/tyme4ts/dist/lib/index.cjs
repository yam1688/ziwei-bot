...
class SolarTime extends SecondUnit {
  ...
  subtract(target) {
    ...
    const ts = target.hour * 3600 + target.minute * 60 + target.second;
    let seconds = cs - ts;
    if (seconds < 0) {
      seconds += 86400;
      days--;
